...
[Icons]
; 创建桌面快捷方式
Name: "{commondesktop}\PPTFlow"; Filename: "{app}\pptflow.exe"; WorkingDir: "{app}"; IconFilename: "assets\icons\pptflow.ico"
; 创建开始菜单快捷方式
Name: "{group}\PPTFlow"; Filename: "{app}\pptflow.exe"; WorkingDir: "{app}"; IconFilename: "assets\icons\pptflow.ico"
